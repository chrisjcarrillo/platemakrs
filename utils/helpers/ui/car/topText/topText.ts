...
export const adjustTopTextWidth = (state: string) => {
    if (state === "Alaska") return plateWidth * 0.55;
    if (state === "California") return plateWidth * 0.55;
...
export const adjustTopTextX = (state: string) => {
    if (state === "Alaska") return plateWidth * 0.235;
    ...
    return plateWidth * 0.25;
}

export const adjustTopTextY = (state: string) => {
    if (state === "Alaska") return plateHeight * - 0.625
