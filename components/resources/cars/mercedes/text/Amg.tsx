            ...
            <g>
                <g>
                    <g>
                        <path style={{
                            ...
                            strokeMiterlimit: '20',
                        }} d="M48,14.4c-1.2,0-2.9,0.8-3.6,1.8L11.7,59.5c-0.8,1-0.3,1.8,0.9,1.8h38c1.2,0,2.9-0.8,3.6-1.8l32.7-43.2
				c0.8-1,0.4-1.8-0.9-1.8L48,14.4z"/>
                        <path style={{
                            fill: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M116,16.2c0.8-1,0.4-1.8-0.9-1.8H97.3c-1.2,0-2.9,0.8-3.6,1.8L61,59.5c-0.8,1-0.3,1.8,0.9,1.8h17.9
				c1.2,0,2.9-0.8,3.6-1.8L116,16.2z"/>
                        <path style={{
                            fill: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M126.8,14.4c-1.2,0-2.9,0.8-3.6,1.8L90.4,59.5c-0.8,1-0.4,1.8,0.9,1.8h13.6c1.2,0,2.9-0.8,3.6-1.8l32.8-43.3
				c0.8-1,0.4-1.8-0.9-1.8C140.4,14.4,126.8,14.4,126.8,14.4z"/>
                        <path style={{
                            fill: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M117.6,59.6c-0.8,1-0.4,1.8,0.9,1.8h9.4c1.2,0,2.9-0.8,3.6-1.8l32.7-43.3c0.8-1,0.4-1.8-0.9-1.8h-9.4
				c-1.2,0-2.9,0.8-3.6,1.8L117.6,59.6z"/>
                        <path style={{
                            fill: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M142,59.6c-0.8,1-0.4,1.8,0.9,1.8h6.8c1.2,0,2.9-0.8,3.6-1.8L186,16.5c0.8-1,0.4-1.8-0.9-1.8h-6.8
				c-1.2,0-2.9,0.8-3.6,1.8L142,59.6z"/>
                        <path style={{
                            fill: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M199.9,14.6c-1.2,0-2.9,0.8-3.6,1.8l-32.7,43.2c-0.8,1-0.4,1.8,0.9,1.8h15.9c1.2,0,2.9-0.8,3.6-1.8l5.2-6.9
				...
				L202.3,38.3z"/>
                        <path style={{
                            ...
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M280.9,59.1c0,1.2,1,2.3,2.3,2.3h12.5c1.2,0,2.3-1,2.3-2.3V35.3c0-1.2,0.9-1.8,2-1.1l23.6,13.9c1.1,0.6,3,1.1,4.2,1.1
				...
				c-1.2,0-2.3,1-2.3,2.3L280.9,59.1L280.9,59.1z"/>
                        <path style={{
                            ...
                            stroke: customTemplate?.backgroundSettings?.background?.file?.color ?? '#ffffff',
                            strokeMiterlimit: '20',
                        }} d="M392,59.1c0,1.2,1,2.3,2.3,2.3h92.1c1.2,0,2.3-1,2.3-2.3V35.7c0-1.2-1-2.3-2.3-2.3H441c-1.2,0-2.3,1-2.3,2.3v4.5
