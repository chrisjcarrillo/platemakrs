...
export const Cobra = (props: {
    customTemplate?: ICustomPlateTemplate
}) => {
    const { customTemplate } = props;
    return (
        <svg version="1.1" id="_x0031_" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
        viewBox="0 0 901.5 1290.5" >

   <g style={{
        display: 'none'
       }}>
       <g id="_x32_qV1Nn.tif_00000135651133250681949090000009792697421302410923_" style={{
        display: 'none'
       }}>
           <g>
   ...
   <g id="_x36_wEgah.tif">
       <g>
           <path style={{
            fill: '#d8d8d8'
           }} d="M754.7,1256.2c-9.9,0-19.7,0-29.6,0c-2.3-1-4.9,0.1-7.2-0.7c-15.6-0.1-31.2-1.8-46.7-3.3
           ...
           <g id="Main_Colors">
               <path style={{
                fill: '#d8d8d8'
               }} d="M697.2,106c11.3,3.1,22.5,6.8,33.9,9.3c12.8,2.9,19.6,11.8,25.4,22.3c0.9,1.6,2.4,3.7,0.8,5.5
                   c-1.6,2-4,1.2-6,0.6c-9.3-2.6-18.2-6.7-27.3-9.8c-13.2-4.4-20.7-14.1-26.6-25.7C697.1,107.5,696.6,106.9,697.2,106z"/>
               <path style={{
                fill: '#d8d8d8'
               }} d="M370.3,355c0-10.1,2.6-18.5,5.9-26.9c1.4-3.4,3-3.8,6.2-3c23.1,5.6,46.3,11.1,69.5,16.6
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M495.3,494.9c-24.6,1.5-49.2,0.8-73.9,1.1c-2.2,0-3.2-0.7-4.1-2.6c-11.6-25.1-22.9-50.3-32.3-76.3
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M510.2,509.9c13.5-0.2,36.1-1.2,58.7-1.1c4.8,0,6.8,0.5,7.5,6.3c2.6,20.2,6.2,40.4,10.9,60.2
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M385.2,310.7c8.6-14.6,18.4-28.1,29-41c7.2-8.8,7.4-8.7,18.2-5c56.3,19.1,112.6,38.2,168.9,57.3
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M431.8,249c10.1-10.7,19.8-20.9,29.4-31.2c1.3-1.4,2.4-1.5,4.3-1c41.6,9.7,83.3,19.2,125,28.8
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M471,603.1c13-1.1,25.3-2.2,37.7-3.3c14.2-1.3,28.3-2.6,42.5-3.8c12.2-1.1,24.4-2,36.6-3.1
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M547.6,751.7c-2,0.3-2.9-0.6-3.8-2.4c-9.9-20.1-19.8-40.2-29.8-60.2c-1.4-2.8-0.7-3.1,2.1-3.5
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M581.2,822.6c-1.8,0.4-2.7-0.7-3.5-2.4c-8.1-17.3-16.3-34.5-24.6-51.7c-1.3-2.7-0.7-3.4,2-3.8
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M606.4,878.5c-2.4,0.8-2.8-0.6-3.6-2.3c-5.2-12.1-10.4-24.2-15.9-36.1c-1.5-3.2-0.6-3.9,2.4-4.6
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M700,925.4c0.5,1.8-0.5,2-2.1,2.2c-15.4,1.9-30.8,3.9-46.2,6c-7.2,0.9-14.4,1.8-21.6,2.9
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M600.5,233.1c-11.9-2.7-23.9-5.4-36-8.2c-28.7-6.6-57.3-13.2-86-19.8c-2.6-0.6-2.8-1.1-1-3
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M702.7,941.5c2-0.6,2.6,1.3,2.9,2.8c2.7,11.3,5.3,22.7,8,34c0.7,2.8-1.3,2.8-3.1,3.3
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M721.3,1033.8c0.8,4.6-1.1,6.3-5.6,7.3c-18,3.9-35.9,8.2-53.8,12.6c-2.4,0.6-2.9,0.1-3.3-1.8
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M722.3,1067c-0.8,10.2-1.6,20.5-2.3,30.7c-0.1,1.9-1,2.5-2.8,2.7c-16.8,1.9-33.5,3.8-50.2,5.7
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M699.3,1158.5c-11.9-2.4-24.1-0.2-36.2-2c-2.4-0.4-3.4-0.4-2.8-3.4c1.5-8,2.6-16,2.7-24.2
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M593.8,193.3c-22.5-10-44.4-19.7-66.3-29.4c-3.3-1.5-4.9-2.7-0.6-5.2c2.4-1.4,4.6-3.3,6.7-5.1
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M699.9,1174.3c-0.2,0.4-0.6,1.1-0.9,1.9c-5.1,11.3-11.4,21.9-18.6,31.9c-1.6,2.1-3,2.7-5.4,1.9
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M666.7,1222.4c-6.4,7.9-21.6,12.9-39.5,12.9c4.1-6.9,8-13.6,12-20.3c0.6-1.1,1.8-0.9,2.7-0.6
                   C650.1,1217,658.3,1219.7,666.7,1222.4z"/>
               <path style={{
                fill: '#d8d8d8'
               }} d="M263.8,1043.1c-1,0.8-1.9,1.6-2.8,2.3c-26.6,20.9-48.6,46-67.4,74.1c-1.9,2.9-3.3,3-6.2,1.4
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M267.6,1159.3c-0.8-0.3-1.5-0.7-2.2-1c-19.8-8.1-39-17.5-58.1-27c-2.4-1.2-2.9-2.1-1.2-4.6
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M365.8,1126.1c-0.4,0.6-0.8,1.1-1.2,1.6c-9.8,16.3-17.2,33.8-23.3,51.7c-1.2,3.6-2.6,4.5-6.3,3.4
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M406.9,1194.4c-17.3-1-33.6-2.7-49.7-6.1c-2.4-0.5-3.4-1.5-2.4-4.1c6.3-16.6,12.7-33.1,21.9-48.4
               ...
               <path style={{
                fill: '#d8d8d8'
               }} d="M494.2,1164.6c-6.3,6.7-12.9,11-19.7,14.9c-13.5,7.7-28.2,11.5-43.5,13.7c-2.9,0.4-3.2-1-2.7-3.1
